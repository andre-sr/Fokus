...
function criarElementoTarefa(tarefa) {
    ...
    botao.onclick = () => {
        ...
        //console.log("Nova descrição da tarefa: ", novaDescrição)
        if (novaDescrição) {
...
const removeTarefas = (somementeCompletas) => {
    const seletor = somementeCompletas ? ".app__section-task-list-item-complete" : ".app__section-task-list-item"
